...
/***/ function(module, exports, __webpack_require__) {
	...
	var Grapnel = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5)(module), (function() { return this; }()), __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = __webpack_require__(3),
	    ...
	    rxDom = __webpack_require__(7),
	    MovieManager = new (__webpack_require__(8))(),
	    getJSON = rx.DOM.getJSON;
	
	module.exports = {
	    init: function init() {
	        var $auto = $(".autocomplete");
	        var searchThreshold = 2;
	
	        // begin work
	        var stream = rx.Observable.fromEvent($auto, 'keyup').throttle(300); // also could use .debounce(() => rx.Observable.timer(300))
	
	        stream.filter(function () {
	            return $auto.val().length > searchThreshold;
	        }).map(function () {
	            return getJSON("/api/movies?search=" + $auto.val()).takeUntil(stream);
	        }).concatAll().subscribe(MovieManager.renderFullResults);
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(4)], __WEBPACK_AMD_DEFINE_RESULT__ = function (Rx, exports) {
